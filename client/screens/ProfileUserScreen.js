...
<View className="w-[393px] h-[852px] relative bg-teal-500">
    ...
    <Text className="left-[132px] top-[232px] absolute text-stone-900 text-[21px] font-bold">Jonh Walker</Text>
    <View className="w-[393px] h-[46px] left-0 top-[361px] absolute bg-white border border border border border-stone-300" />
